...
const Projects = () => {
  ...
  return (
    <div className="grid w-full h-full grid-cols-1 gap-4 px-4 bg-white sm:grid-cols-2 lg:grid-cols-3">
      {projects.map((project) => (
        ...
        >
          ...
          />
          <h2 className="absolute bottom-0 w-full py-5 text-xl text-center text-white bg-gray-600">
            {project.title}
          </h2>
