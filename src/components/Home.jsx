  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="flex items-center justify-center w-full gap-3 py-5">
        <button
          onClick={openModal}
          className="px-2 pt-1 pb-2 text-white bg-gray-800 rounded-lg sm:px-5 hover:text-black hover:bg-gray-400"
        >
          Hire Me
        </button>
        <a
          href="https://drive.google.com/file/d/1wbBbFG-U_mJLogQVHh-H5cfkYmW6UeoA/view?usp=sharing"
          target="_blank"
